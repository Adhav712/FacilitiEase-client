...
import { Monitor, Clock, Sprout } from 'lucide-react';
    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Find Your Dream Space With <span className="text-green-400">Ease</span>
            </h1>
            <p className="text-xl text-white mb-8">
              We've more than 100,000 Workspaces, Research facilities, Day Passes & Access to Other Amenities
            </p>
          </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Get some idea from 50+ facilitiease types</p>
          </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              See How FacilitiEase Can Support the <span className="text-green-600">Startups!</span>
            </h2>
